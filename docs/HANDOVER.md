...
พนักงานเปิดจากริชเมนูหรือลิงก์ `https://liff.line.me/2011494585-rYOQzGC5` จะเห็นแถบเมนู 4 ปุ่มด้านบน

| แท็บ | ใช้ทำอะไร |
| --- | --- |
| ลงเวลา | ลงเวลาเข้าออกพร้อมพิกัด GPS |
| ค่าตอบแทน | ดูยอดค่าจ้างของตัวเองรายเดือน แยกค่าแรง OT เงินหัก และยอดคงเหลือรอรับ |
| เงินที่เบิก | ดูรายการเบิกล่วงหน้าและการจ่ายเงินของตัวเองในเดือนนั้น |
| ค่าใช้จ่าย | ส่งรายการค่าใช้จ่ายและดูสถานะ แสดงเฉพาะคนที่เปิดสิทธิ์ไว้ |

สามแท็บหลังมีปุ่มลูกศรซ้ายขวาไว้เลื่อนดูเดือนย้อนหลัง

ตัวเลขค่าตอบแทนใช้สูตรเดียวกับหน้าคำนวณค่าจ้างของผู้ดูแล จึงตรงกันเสมอ แต่มีข้อความกำกับไว้ว่ายอดจริงยืนยันโดยฝ่ายบุคคล

เปิดแท็บตรงจากริชเมนูได้โดยเติม `?p=pay` `?p=advance` หรือ `?p=expense` ต่อท้ายลิงก์ LIFF เช่นทำปุ่มแยกในริชเมนูให้กดเข้าหน้าค่าตอบแทนได้เลย

## รายการค่าใช้จ่ายที่พนักงานส่ง

เปิดสิทธิ์ให้เป็นรายคนที่หน้า พนักงาน คลิกที่แถวแล้วเปิดสวิตช์ ส่งรายการค่าใช้จ่ายผ่าน LINE ได้ ค่าเริ่มต้นคือปิดทุกคน

พนักงานที่มีสิทธิ์จะเห็นแท็บ ค่าใช้จ่าย ในหน้า LINE กรอกวันที่ ประเภท จำนวนเงิน และรายละเอียด แล้วกดส่ง ลบเองได้เฉพาะรายการที่ยังรอตรวจ
