...
เปิด `https://timework.scriptbin.dev/` จะถูกพาไปหน้าเข้าสู่ระบบ ใช้อีเมลและรหัสผ่านของบัญชีผู้ดูแลที่ได้รับอนุมัติแล้ว

บัญชีแรกสร้างจาก `ADMIN_BOOTSTRAP_EMAIL` ใน `.env` แล้วอ่านลิงก์ตั้งรหัสผ่านได้จาก `docker compose logs api`

คนใหม่กด ส่งคำขอใช้งาน ที่หน้าเข้าสู่ระบบ แล้วรอผู้ดูแลระบบอนุมัติและกำหนดบทบาท มี 4 บทบาท ผู้ดูแลระบบ ฝ่ายบุคคล การเงิน และหัวหน้าแผนก

`ADMIN_API_KEY` ยังใช้ได้กับ `curl` และสคริปต์ โดยมีสิทธิ์เท่าผู้ดูแลระบบ

รายละเอียดทั้งหมดอยู่ใน [docs/HANDOVER.md](docs/HANDOVER.md)
